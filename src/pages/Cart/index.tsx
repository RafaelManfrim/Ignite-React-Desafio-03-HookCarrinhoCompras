...
const Cart = (): JSX.Element => {
  ...
  function handleProductIncrement(product: Product) {
    const productModified = cart.find(item => item.id === product.id)
    if(productModified){
      productModified.amount = product.amount + 1
      updateProductAmount({ 
        productId: productModified.id,
        amount: productModified.amount
      })
    }
  }
